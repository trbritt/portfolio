			...
			{isOpen && (
				...
				>
					<div className="flex opacity-100 flex-col py-8 px-4 rounded-2xl text-center">
						...
						<motion.div
							className="flex items-end justify-center h-full pt-4 px-4 pb-20 text-center sm:block sm:p-0 "
							initial={{
								opacity: 0,
								scale: 0.5,
							}}
						...
						>
							...
							<div
								className="inline-block align-center bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-center sm:max-w-lg sm:w-full"
								role="dialog"
								aria-modal="true"
